      ...
      <div className="bg-bg-secondary border border-border-DEFAULT rounded-xl w-full max-w-md p-6 shadow-xl">
        ...
        <div className="space-y-3 mb-5 text-sm text-text-secondary">
          <div className="rounded-lg border border-border-DEFAULT px-3 py-2.5">
            ...
            <p>
              Hides this lecture in Course Dashboard. PDF, topic cards, and notes stay in the folder on
              disk.
            </p>
          </div>
          <div className="rounded-lg border border-red-900/50 bg-red-950/20 px-3 py-2.5">
            ...
            <p>
              Permanently deletes this lecture folder — extracted text, topic cards, notes, and PDF.
            </p>
            <label className="flex items-start gap-2 mt-3 cursor-pointer">
              <input
                ...
                className="mt-0.5"
              />
              <span className="text-xs text-red-200/90">I understand this cannot be undone</span>
            </label>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            onClick={() => run('disk')}
            className="w-full py-2.5 rounded-lg bg-red-600 hover:bg-red-500 text-white text-sm font-medium disabled:opacity-40"
          >
            Delete from app and disk
          </button>
          <button type="button" disabled={busy} onClick={onCancel} className="w-full py-2 text-sm text-text-muted">
            Cancel
          </button>
        </div>
      </div>
